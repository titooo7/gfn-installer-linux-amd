...
DESKTOP_FILE_PATH="$HOME/Desktop/$DESKTOP_FILE_NAME" # The icon on the desktop
...
echo "6. Locating and modifying the main application menu shortcut..."
...
# Modify the main application menu file to use our custom script
sed -i "s|^Exec=.*|Exec=$LAUNCHER_SCRIPT_PATH|" "$MENU_FILE_PATH"
